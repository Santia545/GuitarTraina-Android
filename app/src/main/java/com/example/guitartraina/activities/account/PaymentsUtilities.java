...
public class PaymentsUtilities {
    ...
    public static JSONObject getPaymentDataRequest(long priceCents) {
        ...
        final String price = PaymentsUtilities.centsToString(priceCents);

        try {
            JSONObject paymentDataRequest = PaymentsUtilities.getBaseRequest();
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(PaymentsUtilities.getCardPaymentMethod()));
            paymentDataRequest.put("transactionInfo", PaymentsUtilities.getTransactionInfo(price));
            paymentDataRequest.put("merchantInfo", PaymentsUtilities.getMerchantInfo());
    ...
    /**
     * Converts cents to a string format accepted by {@link PaymentsUtilities#getPaymentDataRequest}.
     *
